        ...
        <div className="Home">
            ...
            <div className="Home__card-box">
                ...
                <div className="Feature__card">
                    ...
                    <p className="Feature__body">Goalpost tracks your goal for the day so that people can see what you are working on today.</p>
                    <Link to="/feed">
                ...
                <div className="container">
                    <div className="Professional__card">
                        <h2 className="Professional__head">Professional</h2>
                        ...
                        <ul className="Professional__list">
                            <li className="Professional__item">
                                <span>&#10003;</span>Post your goal
                            </li>
                            <li className="Professional__item">
                                <span>&#10003;</span>See what people are doing
                            </li>
                            <li className="Professional__item">
